namespace ts.projectSystem {
    ...
    describe("discover typings", () => {
        ...
        it("should use cached locations", () => {
            ...
            const cache = createMapFromTemplate<JsTyping.CachedTyping>({ node: { typingLocation: node.path, version: Version.parse("1.3.0") } });
        ...
        it("should install expired typings", () => {
            ...
            const cache = createMapFromTemplate<JsTyping.CachedTyping>({
                node: { typingLocation: node.path, version: Version.parse("1.3.0") },
                commander: { typingLocation: commander.path, version: Version.parse("1.0.0") }
            });
        ...
        it("should install expired typings with prerelease version of tsserver", () => {
            ...
            const host = createServerHost([app]);
            const cache = createMapFromTemplate<JsTyping.CachedTyping>({
                node: { typingLocation: node.path, version: Version.parse("1.0.0") }
            });
            const registry = createTypesRegistry("node");
        ...
        it("prerelease typings are properly handled", () => {
            ...
            const host = createServerHost([app]);
            const cache = createMapFromTemplate<JsTyping.CachedTyping>({
                node: { typingLocation: node.path, version: Version.parse("1.3.0-next.0") },
                commander: { typingLocation: commander.path, version: Version.parse("1.3.0-next.0") }
            });
            const registry = createTypesRegistry("node", "commander");
